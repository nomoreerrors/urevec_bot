...
enum ResNewUsersCmd: string
{
    ...
    case DISABLE_ALL_RESTRICTIONS = "Отключить все ограничения для новых пользователей";
    case ENABLE_ALL_RESTRICTIONS = "Включить все ограничения для новых пользователей";
    ...
    public function replyMessage()
    {
        return match ($this) {
            ...
            self::DISABLE_ALL_RESTRICTIONS => 'Все ограничения для новых участников отключены',
            self::ENABLE_ALL_RESTRICTIONS => 'Все ограничения для новых участников включены'
        };
    }
