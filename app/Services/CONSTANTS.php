...
class CONSTANTS
{
    ...
    public const REQUEST_FROM_UNKNOWN_IP = "ERROR: ЗАПРОС К СЕРВЕРУ С НЕИЗВЕСТНОГО IP ИЛИ ENV-СПИСОК РАЗРЕШЕННЫХ АДРЕСОВ НЕ УСТАНОВЛЕН. " . PHP_EOL;
    ...
    public const REQUEST_FROM_UNKNOWN_CHAT_ID = "ERROR: ВХОДЯЩИЙ ЗАПРОС С НЕИЗВЕСТНОГО CHAT_ID ИЛИ СПИСОК РАЗРЕШЕННЫХ ЧАТОВ В ФАЙЛЕ ENV НЕ УСТАНОВЛЕН." . PHP_EOL;
